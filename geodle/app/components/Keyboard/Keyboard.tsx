...
export default function Keyboard({
    ...
    function handleReset(e: React.MouseEvent<HTMLButtonElement>): void {
        e.preventDefault();
        ...
        <div className="space-y-2">
            ...
            <div className="flex items-center justify-center space-x-2">
                ...
                <div className="tooltip" data-tip="Delete last input letter">
                    <button
                        className="border-2 hidden lg:inline-flex items-center justify-center w-12 h-12 bg-red-500 border-red-500 text-white rounded"
                        onClick={onDelete}
                    >
